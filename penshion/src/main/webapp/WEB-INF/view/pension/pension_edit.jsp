...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/member.css">
			...
			<input type="hidden" name="pension_no" value="${pension.pension_no}">
				...
				<div class="btnArea text-center">
					...
					<a href="${pageContext.request.contextPath}/pension/pension_info?pension_no=${pension_no}"><img src="http://img.echosting.cafe24.com/skin/base_ko_KR/member/btn_member_join_cancel.gif" alt="회원가입취소" /></a>
