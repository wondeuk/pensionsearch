...
<link rel="stylesheet" type="text/css" href="css/member_myinfo.css">
			...
			<aside>
				<div class="row">
					<ul>
						<li><a href="#" class="">나의 정보</a></li>
						<li><a href="#" class="">적립금</a></li>
						<li><a href="#" class="">회원 정보 수정</a></li>
						...
						<tr>
							<div class="area-80 center">
								<td colspan="4" class="answer">
									...
									<div class="row">
										<p class="reply">A). 안녕하세요 고객님.^^ 사랑더, 희망더 객실은 공동바베큐장을 이용하셔야 합니다. 기쁨더(1층) 객실을 제외한 전 객실 모두 공동 실내바베큐장을 이용하셔야 하니 참고하시기 바랍니다. 감사합니다!asdfasdfasdfasfasfasdfasdfadffa
										</p>
									</div>
								</td>
							</div>
