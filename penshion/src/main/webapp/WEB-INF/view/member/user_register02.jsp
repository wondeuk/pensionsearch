						...
						<div class="boardWrite">
							<table>
								...
								<tbody>
									...
									<tr>
										<th id="{$name_title}">이름 <img src="${pageContext.request.contextPath}/img/ico_required.gif" /></th>
										<td>
									...
									<tr class="company">
										...
										<td id="companyName"><input name="company_name" class="inputTypeText" id="cname" type="text" maxlength="20" value=""></td>
									</tr>
									<tr class="company">
									...
									<tr class="company">
										...
										<td><input id="phone1" name="phone01" maxlength="4" value="" type="text">- <input id="phone2" name="phone02" maxlength="4" value="" type="text">- <input id="phone3" name="phone03" maxlength="4" value="" type="text"></td>
									</tr>
									<tr>
									...
									<tr class="company">
										...
										<td>
											<input type="text" id="sample6_postcode" placeholder="우편번호" name="loc01">
									...
									<tr class="company">
										<th>홈페이지 도메인 <img src="${pageContext.request.contextPath}/img/ico_required.gif" class="{$display_required_cell|display}" /></th>
